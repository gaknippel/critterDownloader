    ...
    <Sidebar className="pt-10">
      ...
      <SidebarFooter className="p-4 border-t border-sidebar-border bg-sidebar-accent/20">
        <SidebarMenu className="gap-2">
          ...
          <SidebarMenuItem>
            <SidebarMenuButton asChild size="lg" className="px-4 py-6 rounded-lg transition-all duration-200">
              <a href="https://ko-fi.com/crittercast" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3">
                <svg role="img" viewBox="0 0 24 24" className="!size-5 fill-muted-foreground group-hover:fill-[#FF5E5B] transition-colors duration-200" xmlns="http://www.w3.org/2000/svg">
                ...
                <span className="text-sm font-semibold">support on Ko-fi!</span>
              </a>
            </SidebarMenuButton>
          </SidebarMenuItem>
        </SidebarMenu>
